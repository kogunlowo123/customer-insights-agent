"""Application configuration for Customer Insights Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="customer-insights-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/customer_insights_agent",
    ...
    opensearch_index: str = Field(default="customer_insights_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="customer-insights-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="customer-insights-agent", description="A2A agent ID")
