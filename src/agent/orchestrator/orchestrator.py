"""Customer Insights Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Customer Insights Agent through a multi-step pipeline.
